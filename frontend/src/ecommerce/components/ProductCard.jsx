  ...
  return (
    <div className="group overflow-hidden rounded-2xl bg-gray-100">
      <div className="flex h-72 items-center justify-center bg-gray-200">
        <div className="text-6xl transition duration-300 group-hover:scale-110">{product.icon}</div>
      </div>
      <div className="p-6">
        ...
        <div className="mt-5 flex items-center justify-between">
          ...
          <button className="rounded-full bg-black px-4 py-2 text-sm text-white">Buy</button>
        </div>
      </div>
    </div>
  );
